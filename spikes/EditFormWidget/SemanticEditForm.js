...
function buildFormPanel(layout_definition, parent_element) {
  ...
  var p = parent_element.append("<div id=\""+layout_definition.element_id+"\" class=\"ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs-hide\">Some new layout</div>");
  var ul = p.append("<ul></ul>");
  var c = ul.append("<li>Doobrie</li>");
  var parent_context = "";
